defmodule Baud.ApiTest do
  ...
  test "baud test" do
    ...
    :ok = Baud.rtu(pid0, {:fc, 1, 3200, 1}, 400)
    ...
    :ok = Baud.rtu(pid0, {:fc, 1, 3200, 0}, 400)
    ...
    :ok = Baud.rtu(pid0, {:fc, 1, 3201, 1}, 400)
    ...
    :ok = Baud.rtu(pid0, {:fc, 1, 3207, 1}, 400)
    ...
    :ok = Baud.rtu(pid0, {:fc, 1, 3200, [1,0,1,1,1,0,0,1]}, 400)
    ...
    {:ok, [1,0,1,1,1,0,0,1]} = Baud.rtu(pid0, {:rc, 1, 3200, 8}, 400)
    ...
    :ok = Baud.rtu(pid0, {:fc, 1, 3200, [1,0,1,1]}, 400)
    ...
    {:ok, [1,0,1,1]} = Baud.rtu(pid0, {:rc, 1, 3200, 4}, 400)
    ...
    :ok = Baud.rtu(pid0, {:fc, 1, 3204, [1,0,0,1]}, 400)
    ...
    {:ok, [1,0,0,1]} = Baud.rtu(pid0, {:rc, 1, 3204, 4}, 400)
    ...
    :ok = Baud.rtu(pid0, {:fc, 1, 3202, [1,1,1,0]}, 400)
    ...
    {:ok, [1,1,1,0]} = Baud.rtu(pid0, {:rc, 1, 3202, 4}, 400)
